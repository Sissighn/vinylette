...
final class SpotifyController: ObservableObject {
    ...
    func playPause() { run("tell application \"Spotify\" to playpause"); poll() }
    func nextTrack() { run("tell application \"Spotify\" to next track"); poll() }
    func previousTrack() { run("tell application \"Spotify\" to previous track"); poll() }
